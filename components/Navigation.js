...
function Header() {
    return (
        <nav className='fixed text-white h-[64px] bg-[rgba(256,256,256,0.1)] w-[100%] justify-around pr-[1rem] pl-[1rem] flex items-center'>
            <div className='nav-logo flex items-center'><Image src="/icon.png" width={50} height={50} className='rounded-full overflow-hidden' alt='nav-logo' /><span className='text-2xl font-extrabold ml-[10px] b'>Hasilan.net</span></div>
            <div className='flex'>
